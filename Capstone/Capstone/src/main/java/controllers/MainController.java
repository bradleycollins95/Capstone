...
import dataaccess.AutoRepository;
import dataaccess.HomeRepository;
...
//
    ...
    public @ResponseBody Object getAllAutosByUser(@PathVariable("id") Long userId) {
        if (userRepository.existsById(userId)) {
    ...
    public @ResponseBody String updateAuto(
        ...
        return "Auto ID: " + (autoId) + " not found.";
    }
